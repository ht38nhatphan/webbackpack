    ...
    <div id="pricing" class="cards-3">
        ...
        <main class="container">
            <div class="row">
                <!-- Left Column Image -->
                <div class="col-lg-8">
                    <h2 class="header-product">Product Detail</h2>
                    <span class="product-back">/</span>
                    <span> <a class="product-back backk" href="product.aspx">Product</a></span>
                        ...
                        <div class="card2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="product-price">
                                    ...
                                    <div class="button-wrapper">
                                        <a class="btn-solid-reg page-scroll" href="#request" runat ="server" onserverclick="add_click">ADD TO CART</a>
                                    </div>
                                </div>
                            </div>
