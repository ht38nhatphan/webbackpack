<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-services.aspx.cs" Inherits="websitebackpack.add_services" EnableEventValidation="false"%>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="pricing" class="cards-2">
        <div class="container1">
            <h2 class="header-product">Manage Service</h2>
            <section class="orderby1">
                <a class="btn-solid-reg1 page-scroll" href="services-admin.aspx">Back</a>
            </section>
            ...
            <div class="wp-contentt">
                <div class="col-md-4">
                     <asp:FileUpload id="imgload" runat="server"  onchange="ShowButton();"></asp:FileUpload>
                    <!-- Card-->
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-lg-7">
                    <form id="input-manage" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control-input1" runat="server" name="" id="Description" cols="20" rows="5"></textarea>
                        </div>

                        <div class="form-group">
                            <button type="submit" runat="server" onserverclick="add_click" class="form-control-submit-button1">ADD</button>
                        </div>
