<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage-product.aspx.cs" Inherits="websitebackpack.manage_product" EnableEventValidation="false"%>

<!DOCTYPE html>
<script type="text/javascript">
    function a() {
        var c = document.getElementById('vas').src;
        '<%Session["img"] = "' + c + '";%>';
    }
</script>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="pricing" class="cards-2">
        <div class="container1">
            ...
            <section class="orderby1">
                <a class="btn-solid-reg1 page-scroll" href="product-admin.aspx">Back</a>
            </section>
           ...
           runat="server"  onchange="ShowButton();">
                   ...
                   <%-- <input type="file" id="imgload"> --%>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <asp:Image class="shop-image" ID="vas" runat="server" ImageUrl="" />
                            <%--<img class="shop-image"  id="vas" src=""  >--%>
                        </div>
                    </div> <!-- end of card -->
                ...
                <div class="col-lg-7">
                    <form id="input-manage" data-toggle="validator" data-focus="false">
                        <div class="form-group">
                            <label class="" for="cname">Name</label>
                            <input type="text" class="form-control-input1" runat="server" id="cname" required>
                        </div>
                        <div class="form-group">
                            <label class="" for="number">Price ($)</label>
                            <input type="text" class="form-control-input1" runat="server" id="number" required>
                        </div>
                        <div class="form-group">
                            <label class="" for="Description">Description</label>
                            <textarea class="form-control-input1" name="" runat="server" id="Description" cols="20" rows="5"></textarea>
                        </div>
    ...
    <link type="text/css" href="/assets/css/showMessage.css" rel="stylesheet" media="screen" />
    </form>
</body>
<script>
