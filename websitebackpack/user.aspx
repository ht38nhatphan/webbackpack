<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user.aspx.cs" Inherits="websitebackpack.user" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="text-container">
                            <a href="user.aspx"><h5>Dashboard</h5></a>
                            <hr class="cell-divide-hr">
                            <a href="shop.aspx"><h5>Orders</h5></a>
                            <hr class="cell-divide-hr">
                            <a href="login.aspx" runat="server" onserverclick="logout_click"><h5>Log Out</h5></a>
                            <hr class="cell-divide-hr">
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-8"  runat ="server" id="useremail">
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
